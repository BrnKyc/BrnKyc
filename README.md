...
Web application developed with Spring Boot, Java, and HTML that simulates an online pizza ordering system.
Users can browse pizzas, add items to a shopping cart, and complete a simulated payment process.
The application includes user authentication with roles and uses Spring Data JPA repositories for data management.
